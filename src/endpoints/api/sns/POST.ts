import { CONNECTED_APPLICATION_STATUS_CONNECTED, CONNECTION_METHOD_ACCESS_KEYS, PROVIDER_AMAZON_SNS } from '@/constants';
...
import type { AccessKeyCredentials } from '@/model';
